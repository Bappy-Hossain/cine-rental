...
export default function MovieDetails({ movie, onClose, onCartAdd }) {
  return (
    <div className="fixed top-0 left-0 text-black w-screen h-screen z-50 bg-black/60 backdrop-blur-sm">
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[984px] p-4 max-h-[90vh] overflow-auto">
        <div className="bg-white shadow-md dark:bg-[#12141D] dark:text-white rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
          <img
